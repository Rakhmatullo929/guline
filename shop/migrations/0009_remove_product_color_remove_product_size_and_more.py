...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0008_remove_category_description_en_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(max_length=200, null=True, verbose_name='Часы работы'),
        ),
        migrations.AddField(
            model_name='contact',
        ...
        migrations.AddField(
            ...
            field=models.TextField(blank=True, null=True, verbose_name='Инструкции по уходу'),
        ),
        migrations.AddField(
            model_name='product',
